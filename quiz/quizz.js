...
let seniorTest = [
  [
   ...
   questionText: "Look at the O'clock in Ha Noi, what time is it now?",
     image: "https://www.upsieutoc.com/images/2020/11/27/anh-de-GPA-9.png",
     answerOptions: [
       { answerText: "5 AM", isCorrect: true },
       { answerText: "6 AM", isCorrect: false },
       { answerText: "7 AM", isCorrect: false },
     ],
     hints: [
       { hint1: "Vietnamese clock but you are in Russia" },
     ],
       ...
       questionText: "How many triangles are there?",
        image: "https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-1.png",
         answerOptions: [
              ...
              { answerText:"Eleven", isCorrect: true},
            { answerText:"Nine", isCorrect:false},
            { answerText:"Sixteen", isCorrect:false},
          ],
          hints:[
              {hint1: "More than eight"},
          ],
 ...
 
   {
     questionText: "Convert to Hexadecimal: 0000 0011 0101 0010 0001 0010",
     image:
       "https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-3.png",
     answerOptions: [
       { answerText: "0 4 5 2 1 2", isCorrect: false },
       { answerText: "0 2 5 2 1 1", isCorrect: false },
       { answerText: "0 3 5 2 1 2", isCorrect: true },
     ],
     hints: [
       { hint1: "Look at binary sector" },
     ],
   ...
   //Convert
   {
     ...
     image:
       "https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-3.png",
     answerOptions: [
       { answerText: "0 2 4 6 ", isCorrect: false },
       { answerText: "0 1 2 5 ", isCorrect: false },
       { answerText: "1 3 2 3 ", isCorrect: true },
     ],
     hints: [
       { hint1: "Look at binary sector" },
     ],
   ...
   //brainOut
   {
     ...
     hints: [{ hint1: "5 - 3 = 2;  9 - 1 = 8;  8 - 6 = 2; 5 - 4 = 1" }],
             correctAnswer: "410"
   },
 
 // ádklaskmdlasdklnalkandldnlsad
  ...
  [
   ...
   //Convert
   {
     ...
     image:
       "https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-3.png",
     answerOptions: [
       { answerText: "0 3 5 6 ", isCorrect: false },
       { answerText: "0 2 1 5 ", isCorrect: false },
       { answerText: "5 2 6 7 ", isCorrect: true },
     ],
     hints: [
       { hint1: "Look at binary sector" },
     ],
   ...
   //brainOut
   {
     ...
     image:"https://www.upsieutoc.com/images/2020/11/25/anh-de-GPA-4.png",
     answerOptions: [
       {answerText:"BC & BE", isCorrect: true},
       {answerText:"BC & DE", isCorrect:false},
       {answerText:"AC & BE",isCorrect:false}
     ],
     hints:[
       {hint1:"Try to move BC" }
     ],
  ...
  [
   ...
   //Convert to binary
   {
     ...
     image:
       "https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-3.png",
     answerOptions: [
       { answerText: "0001 1010", isCorrect: true },
       { answerText: "12 10 ", isCorrect: false },
       { answerText: "00012 1011", isCorrect: false },
     ],
     hints: [{ hint1: "Which base has A? " }],
     correctAnswer: "0001 1010"
   },
   //Convert into Decimal
   {
     ...
     image:
       "https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-3.png",
     answerOptions: [
       { answerText: "7 1 3 4", isCorrect: false },
       { answerText: "0 2 10 11", isCorrect: true },
       { answerText: "1 3 5 7", isCorrect: false },
     ],
     hints: [
       { hint1: " first number is less than 3" },
     ],
   ...
   //BrainOut question
   {
     ...
     image: 'https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-7.png',
     answerOptions: [
       { answerText: "8+8=16", isCorrect: true }, 
       { answerText: "10-1=9", isCorrect: false },
       { answerText: "6+2=8", isCorrect: false },
     ],
     hints: [
       { hint1: "Right-hand side remains unchanged " },
     ],
  ...
  [
   ...
   //geometry question
   {
     ...
     image: 'https://www.upsieutoc.com/images/2020/11/22/anh-de-GPA-5.png', 
     answerOptions: [
       {answerText: "13 lines", isCorrect:false},
       {answerText: "16 lines", isCorrect:true},
       {answerText: "15 lines", isCorrect:false},
       {answerText: "18 lines", isCorrect:false},
     ],
     hints: [
       {hint1: "More than 13 lines"},
       {hint2: "Less than 18 lines"},
   ...
   //convert question
   {
     ...
     image:"https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-3.png",
     answerOptions: [
       {answerText:"10 15 12 14",isCorrect:true},
       {answerText:"12 10 13 14",isCorrect:false},
       {answerText:"13 10 12 15",isCorrect:false},
       {answerText:"11 10 13 15",isCorrect:false}
      ],
      hints: [
        {hint1: "Look at the hexadecimal sector"},
      ],
   ...
   //convert question
   {
     ...
     image:"https://www.upsieutoc.com/images/2020/11/24/anh-de-GPA-3.png",
     answerOptions: [
       {answerText:"0100 0110 1000 1010", isCorrect:false},
       {answerText:"4 7 10 12", isCorrect:true},
       {answerText:"13 11 20 00", isCorrect:false},
       {answerText:"8 7 6 12 ", isCorrect:false}
     ],
     hints: [
       {hint1:"Look at the binary sector"},
     ],
   ...
   //brainOut question
   {
     questionText:"Find x: 1 = 5; 2 = 15; 3 = 215; 4 = 3215; 5 = x",
     answerOptions:[
       {answerText: "43215", isCorrect:true},
       {answerText: "4215", isCorrect:false},
